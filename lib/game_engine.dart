//TODO learn export hierarchy best practices and refactor

export 'src/game/assets_static.dart';
export 'src/game/camera_static.dart';
export 'src/game/game_canvas_static.dart';
export 'src/game/game_main.dart';
export 'src/game/pogo_widget_static.dart';
export 'src/game/screen_static.dart';
export 'src/game/system_static.dart';
...
export 'src/particles/composite_particle.dart';
