...
typedef ParticleRenderDelegate = void Function(Canvas c, ParticleComponent particle);

/// An abstract [ParticleComponent] container which delegates renderign outside
/// Allows to implement very interesting scenarios from scratch.
class ComputedParticle extends ParticleComponent {
